...
Puppet::Type.newtype(:dsc_spsearchfiletype) do
  ...
  # IsMandatory:  True
  # Values:       None
  newparam(:dsc_filetype) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "FileType - The name of the file type"
    isrequired
    validate do |value|
  ...
  newparam(:dsc_description) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "Description - The description of the file type"
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
  ...
  newparam(:dsc_mimetype) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "MimeType - The mime type of the file type"
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
  ...
  newparam(:dsc_enabled) do
    ...
    def mof_is_embedded?; false end
    desc "Enabled - The state of the file type"
    validate do |value|
    end
