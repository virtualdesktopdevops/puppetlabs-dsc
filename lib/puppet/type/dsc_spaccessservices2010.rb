...
Puppet::Type.newtype(:dsc_spaccessservices2010) do
  ...
  def dscmeta_resource_friendly_name; 'SPAccessServices2010' end
  def dscmeta_resource_name; 'MSFT_SPAccessServices2010' end
