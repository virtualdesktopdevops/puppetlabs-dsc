...
Puppet::Type.newtype(:dsc_spaccessserviceapp) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SPAccessServiceApp resource type.
    Automatically generated from
    'SharePointDsc/DSCResources/MSFT_SPAccessServiceApp/MSFT_SPAccessServiceApp.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'SPAccessServiceApp' end
  def dscmeta_resource_name; 'MSFT_SPAccessServiceApp' end
  ...
  newparam(:dsc_databaseserver) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "DatabaseServer - The name of the database server to host Access Services databases"
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
