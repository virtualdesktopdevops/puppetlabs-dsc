...
Puppet::Type.newtype(:dsc_spuserprofilesection) do
  ...
  def dscmeta_resource_friendly_name; 'SPUserProfileSection' end
  def dscmeta_resource_name; 'MSFT_SPUserProfileSection' end
