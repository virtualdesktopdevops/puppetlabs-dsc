...
Puppet::Type.newtype(:dsc_xd7storefrontreceiverauthenticationmethod) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC XD7StoreFrontReceiverAuthenticationMethod resource type.
    Automatically generated from
    'XenDesktop7/DSCResources/VE_XD7StoreFrontReceiverAuthenticationMethod/VE_XD7StoreFrontReceiverAuthenticationMethod.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'XD7StoreFrontReceiverAuthenticationMethod' end
  def dscmeta_resource_name; 'VE_XD7StoreFrontReceiverAuthenticationMethod' end
...
Puppet::Type.type(:dsc_xd7storefrontreceiverauthenticationmethod).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
