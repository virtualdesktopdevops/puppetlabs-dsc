...
Puppet::Type.newtype(:dsc_spperformancepointserviceapp) do
  ...
  def dscmeta_resource_friendly_name; 'SPPerformancePointServiceApp' end
  def dscmeta_resource_name; 'MSFT_SPPerformancePointServiceApp' end
