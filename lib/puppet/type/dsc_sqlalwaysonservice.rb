...
Puppet::Type.newtype(:dsc_sqlalwaysonservice) do
  ...
  def dscmeta_resource_friendly_name; 'SqlAlwaysOnService' end
  def dscmeta_resource_name; 'MSFT_SqlAlwaysOnService' end
