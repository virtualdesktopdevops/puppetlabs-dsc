...
Puppet::Type.newtype(:dsc_spsubscriptionsettingsserviceapp) do
  ...
  def dscmeta_resource_friendly_name; 'SPSubscriptionSettingsServiceApp' end
  def dscmeta_resource_name; 'MSFT_SPSubscriptionSettingsServiceApp' end
