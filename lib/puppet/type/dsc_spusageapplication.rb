...
Puppet::Type.newtype(:dsc_spusageapplication) do
  ...
  def dscmeta_resource_friendly_name; 'SPUsageApplication' end
  def dscmeta_resource_name; 'MSFT_SPUsageApplication' end
