...
Puppet::Type.newtype(:dsc_spwebappproxygroup) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SPWebAppProxyGroup resource type.
    Automatically generated from
    'SharePointDsc/DSCResources/MSFT_SPWebAppProxyGroup/MSFT_SPWebAppProxyGroup.schema.mof'
  ...
  newparam(:dsc_webappurl) do
    ...
    desc "WebAppUrl - URL of the web application"
    isrequired
    validate do |value|
