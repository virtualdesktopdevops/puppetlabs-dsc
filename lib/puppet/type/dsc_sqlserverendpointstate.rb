...
Puppet::Type.newtype(:dsc_sqlserverendpointstate) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SqlServerEndpointState resource type.
    Automatically generated from
    'SQLServerDsc/DSCResources/MSFT_SqlServerEndpointState/MSFT_SqlServerEndpointState.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'SqlServerEndpointState' end
  def dscmeta_resource_name; 'MSFT_SqlServerEndpointState' end
