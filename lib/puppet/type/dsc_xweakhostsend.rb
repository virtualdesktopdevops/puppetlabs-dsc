...
Puppet::Type.newtype(:dsc_xweakhostsend) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC xWeakHostSend resource type.
    Automatically generated from
    'xNetworking/DSCResources/MSFT_xWeakHostSend/MSFT_xWeakHostSend.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'xWeakHostSend' end
  def dscmeta_resource_name; 'MSFT_xWeakHostSend' end
  ...
  newparam(:dsc_interfacealias) do
    ...
    desc "InterfaceAlias - Alias of the network interface for which the Weak Host Sending is set."
    isrequired
    validate do |value|
  ...
  newparam(:dsc_state) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "State - The desired state of the Weak Host Sending. Valid values are Enabled, Disabled."
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
