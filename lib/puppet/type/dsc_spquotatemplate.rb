...
Puppet::Type.newtype(:dsc_spquotatemplate) do
  ...
  def dscmeta_resource_friendly_name; 'SPQuotaTemplate' end
  def dscmeta_resource_name; 'MSFT_SPQuotaTemplate' end
  ...
  newparam(:dsc_name) do
    ...
    desc "Name - The name of the quota template"
    isrequired
    validate do |value|
  ...
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_storagemaxinmb) do
  ...
  # Name:         StorageWarningInMB
  # Type:         uint32
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_storagewarninginmb) do
    def mof_type; 'uint32' end
    def mof_is_embedded?; false end
  ...
  # Name:         MaximumUsagePointsSolutions
  # Type:         uint32
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_maximumusagepointssolutions) do
    def mof_type; 'uint32' end
    def mof_is_embedded?; false end
  ...
  # Name:         WarningUsagePointsSolutions
  # Type:         uint32
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_warningusagepointssolutions) do
    def mof_type; 'uint32' end
    def mof_is_embedded?; false end
  ...
  newparam(:dsc_ensure) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "Ensure - Present to create this template, absent to ensure it does not exist Valid values are Present, Absent."
    validate do |value|
