...
Puppet::Type.newtype(:dsc_spprojectserverserviceapp) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SPProjectServerServiceApp resource type.
    Automatically generated from
    'SharePointDsc/DSCResources/MSFT_SPProjectServerServiceApp/MSFT_SPProjectServerServiceApp.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'SPProjectServerServiceApp' end
  def dscmeta_resource_name; 'MSFT_SPProjectServerServiceApp' end
  ...
  newparam(:dsc_proxyname) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "ProxyName - The name of the Project Server Service Application Proxy"
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
