...
Puppet::Type.newtype(:dsc_spfarm) do
  ...
  # Name:         RunCentralAdmin
  # Type:         boolean
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_runcentraladmin) do
    def mof_type; 'boolean' end
    def mof_is_embedded?; false end
    desc "RunCentralAdmin - Should the central admin site run on this specific server?"
    validate do |value|
    end
