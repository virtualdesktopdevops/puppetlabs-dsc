...
Puppet::Type.newtype(:dsc_xsqlserverpermission) do
...
Puppet::Type.type(:dsc_xsqlserverpermission).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
