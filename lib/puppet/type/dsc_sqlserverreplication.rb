...
Puppet::Type.newtype(:dsc_sqlserverreplication) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SqlServerReplication resource type.
    Automatically generated from
    'SQLServerDsc/DSCResources/MSFT_SqlServerReplication/MSFT_SqlServerReplication.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'SqlServerReplication' end
  def dscmeta_resource_name; 'MSFT_SqlServerReplication' end
