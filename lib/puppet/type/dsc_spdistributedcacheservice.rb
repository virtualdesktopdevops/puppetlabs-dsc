...
Puppet::Type.newtype(:dsc_spdistributedcacheservice) do
  ...
  def dscmeta_resource_friendly_name; 'SPDistributedCacheService' end
  def dscmeta_resource_name; 'MSFT_SPDistributedCacheService' end
