...
Puppet::Type.newtype(:dsc_xsqlserverdatabaseowner) do
...
Puppet::Type.type(:dsc_xsqlserverdatabaseowner).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
