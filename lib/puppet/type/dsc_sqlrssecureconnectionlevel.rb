...
Puppet::Type.newtype(:dsc_sqlrssecureconnectionlevel) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC SqlRSSecureConnectionLevel resource type.
    Automatically generated from
    'SQLServerDsc/DSCResources/MSFT_SqlRSSecureConnectionLevel/MSFT_SqlRSSecureConnectionLevel.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'SqlRSSecureConnectionLevel' end
  def dscmeta_resource_name; 'MSFT_SqlRSSecureConnectionLevel' end
...
Puppet::Type.type(:dsc_sqlrssecureconnectionlevel).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
