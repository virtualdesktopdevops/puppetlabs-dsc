...
Puppet::Type.newtype(:dsc_xpowerplan) do
  ...
  def dscmeta_resource_friendly_name; 'xPowerPlan' end
  def dscmeta_resource_name; 'MSFT_xPowerPlan' end
  ...
  newparam(:dsc_name) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "Name - The name of the power plan to activate."
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
